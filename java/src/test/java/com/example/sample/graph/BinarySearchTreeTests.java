...
public class BinarySearchTreeTests {
    ...
    public void run() {
        ...
        System.out.println("IsPresent \"8\" ? >>> " + bst.isPresentRecursive(bst.getRoot(), 8));
        System.out.println();

        System.out.println("IsPresent \"40\" ? >>> " + bst.isPresentRecursive(bst.getRoot(), 40));
        System.out.println();

        System.out.println("IsPresent \"13\" ? >>> " + bst.isPresentRecursive(bst.getRoot(), 13));
        System.out.println();
    }
}
